...
3. Run tests defined in the story (`npx nx test api --testPathPattern=...`).
...
| US-004 | Portfolio risk analysis tool (Ghostfolio service integration) | `todo` | P0       | US-002, US-003         |
| US-005 | ESG compliance checker with domain verification               | `todo` | P0       | US-002, US-003         |
| US-006 | Conversation memory and error handling                        | `todo` | P0       | US-003, US-004, US-005 |
...
4. US-007 sequentially (final MVP gate)
